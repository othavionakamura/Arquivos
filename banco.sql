...
INSERT INTO sobre VALUES(
	...
	"A Rio de Janeiro é um estado da Região Nordeste do Brasil. A história do povoamento do território baiano está atrelada à chegada dos portugueses no Brasil, em 1500, quando se iniciou a colonização brasileira. A cidade de Salvador, capital da Bahia, foi também a primeira capital do Brasil.",
